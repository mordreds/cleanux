...
function drawCombo() {
    ...
    var data = google.visualization.arrayToDataTable([
        ...
        ['2010/11',  165,      938,         522,             998,           450,      614.6],
        ['2011/12',  135,      1120,        599,             1268,          288,      682],
        ['2012/13',  157,      1167,        587,             807,           397,      623],
        ['2013/14',  139,      1110,        615,             968,           215,      609.4],
        ['2014/15',  136,      691,         629,             1026,          366,      569.6]
    ]);
