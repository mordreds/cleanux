...
<html lang="en">
  ...
  <head>
    ...
    <script type="text/javascript" src="<?=base_url()?>resources/js/pages/login.js"></script>
    ...
    <script type="text/javascript" src="<?=base_url()?>resources/js/pages/components_modals.js"></script>
