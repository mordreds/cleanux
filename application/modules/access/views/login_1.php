          ...
          <form action="<?=base_url()?>access/login_validation" method="post">
            <div class="row">
              ...
              <div class="panel panel-body login-form col-md-4">
                ...
                <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-6"><a href="<?=base_url()?>access/signup" class="btn bg-indigo-400 btn-block legitRipple">Sign up</a></div>
                <div class="col-md-6 col-sm-6 col-xs-6"><a href="<?=base_url()?>access/signup" class="btn bg-pink-600 btn-block legitRipple">Request Demo</a></div>
                </div><br/>
