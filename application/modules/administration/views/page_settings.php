...
<script type="text/javascript">
  ...
  /****** Displaying Department Employees *****/
    $("#all_departments").change(function(){
      ...
      $(".selectbox").data("selectBox-selectBoxIt").remove();
      $("#employeeid").val("");
      $("#email").val("");
      $("#phone_num").val("");
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $.each(employees, function(array_index) {
            ...
            $("#department_employees").data("selectBox-selectBoxIt").add({ value: employees[array_index].id, text: employees[array_index].fullname, 'data-empid': employees[array_index].employee_id,'data-email': employees[array_index].work_email,'data-phone_num': employees[array_index].phone_number_1,'data-fullname': employees[array_index].fullname,
              'data-iconurl':"../"+employees[array_index].profile_photo
            });
          });
        },
        error: function() {
          alert("Members of Department Failed");
        }
      });
    });
  /****** Displaying Department Employees ****/
