            ...
            <div class="panel-body" style="padding: 5px;">
              <div class="col-xs-6 content-group">
                ...
                <ul class="list-condensed list-unstyled">
                  <li><span class="text-muted">Invoice To:</span><span class="text-semibold" id="receipt_client"></span></li>
                  <li><span class="text-muted">Delivery Method:</span><span class="text-semibold" id="receipt_delivery_method"></span></li>
                  <li><span class="text-muted">Balance:</span> <span class="text-semibold" id="receipt_balance"></span></li>
                </ul>
              </div>
              <div class="col-xs-6 content-group">
              ...
              <hr/>
              <div class="col-xs-4">
                <p>NB:Attention to all customers, management shall only bear 30% cost of dresses or clothes and items missing, damaged or stolen.Also we are not responsible for items missing or damaged after 3 months.</p>
                <p>Customer care:0000000000</p>
              </div>
