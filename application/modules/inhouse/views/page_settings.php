  ...
  /************** All Pending Orders Table *********/
    $('#allpending_orders').dataTable({
      ...
      columns: [
        ...
        {render: function(data,type,row,meta) { 
          return '<ul class="action_btns" style="margin-bottom:0px;"><li><button data-order_id="'+row.id+'" class="label bg-green-600 view_order_comments" data-notify_client="Yes" data-send_comment="Yes">Comments ('+row.total_comments+')</button></li></ul>';
        }}
      ],
    });
  ...
  /************** All Cancelled Orders Table *********/
    $('#allcancelled_orders').dataTable({
      ...
      columns: [
        ...
        {render: function(data,type,row,meta) { 
          return '<ul class="action_btns" style="margin-bottom:0px;"><li><button data-order_id="'+row.id+'" class="label bg-green-600 view_order_comments" data-notify_client="No" data-send_comment="No">Comments ('+row.total_comments+')</button></li></ul>';
        }},
      ],
    });
  /************** All Pending Orders Table *********/
