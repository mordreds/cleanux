                  ...
                  <form action="<?=base_url()?>/settings/save_company_details" method="post">
                    ...
                    <div class="row">
                      <div class="col-md-7">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="display-block">GPS Co-ordinates</label>
                            <input type="text" name="website" class="form-control" value="<?=@strtoupper($company_info[0]->gps_location)?>" style="font-weight: 800;">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
