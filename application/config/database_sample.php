...
/*  Permission Database ==>  This Database contains roles and pervileges of both users and groups(if any).   
		Eg: 
...
/*  Audit Database ==>  This Database contians the audit trails of the system. i.e Every activity performed by the user is recordred in this database.
		Eg: 
			user transactions
			change of password
