...
--
-- Host: localhost
-- Generation Time: Jun 21, 2018 at 02:49 AM
...
(115, 1, '2018-05-08 19:37:40', '0000-00-00 00:00:00', 1, 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.162 Safari/537.36 OPR/52.0.2871.30', '::1', 'ip6-localhost', NULL, NULL),
(116, 1, '2018-05-09 00:53:07', '0000-00-00 00:00:00', 1, 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.162 Safari/537.36 OPR/52.0.2871.30', '::1', 'ip6-localhost', NULL, NULL),
(117, 1, '2018-06-21 02:38:46', '0000-00-00 00:00:00', 1, 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.139 Safari/537.36', '::1', 'ip6-localhost', NULL, NULL);
...
--
-- Table structure for table `access_failed_logins`
--

CREATE TABLE `access_failed_logins` (
  `id` int(20) NOT NULL COMMENT 'auto',
  `user_id` int(10) NOT NULL,
  `username` varchar(255) NOT NULL COMMENT 'the username used for logging in ',
  `password` varchar(255) NOT NULL COMMENT 'encrypted password used for logging in ',
...
--
-- Dumping data for table `access_failed_logins`
--

INSERT INTO `access_failed_logins` (`id`, `user_id`, `username`, `password`, `user_agent`, `hostname`, `ipaddress`, `city_region`, `country`, `access_date`) VALUES
(1, 1, 'osborne.mordred@gmail.com', '$2y$10$iR5nohFRLQXTz3O8h2kGzOf1FV0/cAcdnQFGWaT25EDYtZULj5cPq', 'Mozilla/5.0 (X11; Linux i686 (x86_64)) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 OPR/45.0.2552.898', 'ip6-localhost', '::1', NULL, NULL, '2017-12-30 13:47:12'),
(2, 7, 'akosuapompey@maviscolaundry.com', '$2y$10$x.IZEqoTJ1eJp7fCxT5pi.jKequQMXW3KOWGs0clWECRv3dWU7nTi', 'Mozilla/5.0 (X11; Linux i686 (x86_64)) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 OPR/45.0.2552.898', 'ip6-localhost', '::1', NULL, NULL, '2017-12-30 14:16:00');
...
--
-- Table structure for table `access_successful_logins`
--

CREATE TABLE `access_successful_logins` (
  `id` int(20) NOT NULL COMMENT 'auto generated id',
  `user_id` int(5) NOT NULL COMMENT 'auto generated id from users table',
  `time_in` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'time of login by user',
  `time_out` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'time of logout by user',
...
--
-- Dumping data for table `access_successful_logins`
--

INSERT INTO `access_successful_logins` (`id`, `user_id`, `time_in`, `time_out`, `online`, `user_agent`, `ipaddress`, `hostname`, `city_region`, `country`) VALUES
(1, 1, '2017-12-30 11:01:37', '0000-00-00 00:00:00', 0, 'Mozilla/5.0 (X11; Linux i686 (x86_64)) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 OPR/45.0.2552.898', '::1', 'ip6-localhost', NULL, NULL),
(2, 1, '2017-12-30 11:04:07', '0000-00-00 00:00:00', 0, 'Mozilla/5.0 (X11; Linux i686 (x86_64)) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 OPR/45.0.2552.898', '::1', 'ip6-localhost', NULL, NULL),
(3, 1, '2017-12-30 11:16:33', '0000-00-00 00:00:00', 0, 'Mozilla/5.0 (X11; Linux i686 (x86_64)) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 OPR/45.0.2552.898', '::1', 'ip6-localhost', NULL, NULL),
(4, 1, '2017-12-30 12:48:41', '0000-00-00 00:00:00', 0, 'Mozilla/5.0 (X11; Linux i686 (x86_64)) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 OPR/45.0.2552.898', '::1', 'ip6-localhost', NULL, NULL),
...
(115, 1, '2018-05-08 19:37:40', '0000-00-00 00:00:00', 1, 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.162 Safari/537.36 OPR/52.0.2871.30', '::1', 'ip6-localhost', NULL, NULL),
(116, 1, '2018-05-09 00:53:07', '0000-00-00 00:00:00', 1, 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.162 Safari/537.36 OPR/52.0.2871.30', '::1', 'ip6-localhost', NULL, NULL),
(117, 1, '2018-06-07 14:24:15', '0000-00-00 00:00:00', 0, 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.45 Safari/535.19', '192.168.3.54', '192.168.3.54', ',', NULL);
...
INSERT INTO `access_users` (`id`, `username`, `passwd`, `default_passwd`, `fullname`, `phone_number`, `temp_employee_id`, `biodata_id`, `first_login`, `login_attempt`, `status`, `created_by`, `date_created`) VALUES
...
(11, 11, '7', '1', '15', '15', 'red blanket', '', '', '', '2018-06-21 02:46:46');
...
(11, '45063338', 20, 20, 0, 1, 6, 1, 4, 'Abelemkpe', '2018-06-22', 'Pending', 0, NULL, 0, 'Pending', '2018-06-21 02:46:46');
...
--
-- Indexes for table `access_failed_logins`
--
ALTER TABLE `access_failed_logins`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `access_successful_logins`
--
ALTER TABLE `access_successful_logins`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `access_failed_logins`
--
ALTER TABLE `access_failed_logins`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT COMMENT 'auto', AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT for table `access_successful_logins`
--
ALTER TABLE `access_successful_logins`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT COMMENT 'auto generated id', AUTO_INCREMENT=118;
--
